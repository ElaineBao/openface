...
def vali_recall_acc(test_path,sub_db):
    ...
    for person in test_src:
        ...
        test_num+=test_size*len(person_list)
    ...
    print "top1_acc is: %f"%(top1_acc_cnt/test_size)
    print "top10_acc is: %f"%(top10_acc_cnt/test_size)
    print "top10_recall is: %f"%(top10_recall_cnt/(10*test_num))
...
if __name__=='__main__':
    ...
    db_path='./dbinfo.npz'
    test_path='/home/byx/openface-master/test_acc/test'
